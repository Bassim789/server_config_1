...
CREATE TABLE $db_name.user (
	...
	hash VARCHAR(511),
	email VARCHAR(255),
	is_email_valid INT(1),
	phone VARCHAR(31),
	code_activation VARCHAR(511),
	cookie_login VARCHAR(511)
);
CREATE TABLE $db_name.admin_user (
	id INT(32) AUTO_INCREMENT PRIMARY KEY,
	name VARCHAR(255),
	hash VARCHAR(511),
	email VARCHAR(255),
